...
/* register.html */
class __TwigTemplate_f80e791213a7a53cd849366e78f9f0be315b7992cd85d076f1a70cdaf6a5cf68 extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        echo "</h2>
            <form class=\"form\" action=\"/login/register\" method=\"post\">
                ...
                <div class=\"form__btns\">
                    <button type=\"submit\" class=\"form__btn btn btn--regular btn--red\">Зарегистрироваться</button>
                </div>
            </form>
        </div>
    </div>
...
";
    ...
    {
        return new Source("", "register.html", "C:\\OpenServer\\domains\\mvc.week3-5.loftphp\\app\\Views\\register.html");
    }
}
